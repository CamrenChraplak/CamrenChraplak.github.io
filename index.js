/**
 * Implements tables formatted for dates
 */
window.addEventListener('load', (event) => {
    document.getElementById("wpi").innerHTML = makeTable("<b>Worcester Polytechnic Institute (WPI),</b> Worcester, MA", "5/2025");
    document.getElementById("hub").innerHTML = makeTable("<b>Circuithub Intern,</b> South Deerfield, MA", "5/2024 to 8/2024");
    ...
    document.getElementById("weber").innerHTML = makeTable("<b>Camp Weber Intern,</b> West Springfield, MA", "7/2018 to 8/2018");
