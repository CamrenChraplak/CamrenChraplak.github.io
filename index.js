window.addEventListener('load', (event) => {
    ...
    document.getElementById("upe").innerHTML = makeTable("<b>Member,</b> Upsilon Pi Epsilon (Computer Science Honor Society), WPI", "1/2024 to Present");
    document.getElementById("rbe").innerHTML = makeTable("<b>Member,</b> Rho Beta Epsilon (Robotics Honor Society), WPI", "1/2023 to Present");
